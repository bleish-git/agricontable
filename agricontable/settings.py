"""
Django settings for agricontable project.
...
SECRET_KEY = 'django-insecure-^qmlet4(&&yeup6$_t-fy3qp3*j$qvq*ax7(++fb86a^w1s*qz'
...
ROOT_URLCONF = 'agricontable.urls'
...
WSGI_APPLICATION = 'agricontable.wsgi.application'
